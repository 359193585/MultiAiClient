一个将多个web端访问的ai聊天集成的工具，可以多页签并行打开多个ai聊天窗口，在统一的输入框内输入你的提示词，一键发送至所有ai。
程序支持上下定为问题，统计你的提问次数，并可以支持导出全部问题，分析你和ai互动的过程，优化你的提示词。
...
The program supports locating issues, tracking the number of your questions, exporting all questions, analyzing the process of your interaction with AIs, and optimizing your prompts.
